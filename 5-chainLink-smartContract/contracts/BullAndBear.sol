...
contract BullBear is ERC721, ERC721Enumerable, ERC721URIStorage, KeeperCompatibleInterface, Ownable, VRFConsumerBaseV2  {
    ...
    bytes32 keyhash =  0x79d3d8832d904592c0bf9818b621522c988bb8b0c05cdc3b15aea1b6e8db0c15; // keyhash
    ...
    */
    ...
    // BTC/USD Price Feed Contract Address on Goerli
    // Setup VRF. Goerli VRF Coordinator
    ...
    function requestRandomnessForNFTUris() internal {
        ...
        s_requestId = COORDINATOR.requestRandomWords(
            ...
            callbackGasLimit,
            1 // `numWords` : number of random values we want. Max number for Goerli
        );
